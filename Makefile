compile:
	...
	zcc +zx -v -startup=31 -DWFRAMES=3 -clib=sdcc_iy -Cz--screen=intro.scr -SO3 --max-allocs-per-node10000 @zproject.lst -pragma-include:zpragma.inc -pragma-need=fzxterminal -pragma-redirect:CRT_FONT_FZX=_ff_ao_Prefect -o msnampac -create-app
