...
cat loader.tap screen.tap code.tap bank6.tap bank7.tap > /out/msnampac.tap

echo "DSK GENERATION ###################"
/utils/bas2tap -sdisk -a10 loader-p3.bas loader-p3.tap

rm -f disk screen code bank6 bank7
...
/utils/taptools/tapsplit bank7.tap
...
/usr/bin/cpmcp -f cpcdata  /out/msnampac.dsk bank7 0:bank7
